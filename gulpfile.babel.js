 ...
 */
export const start = series(fonts, json, parallel(styles, views, scripts, images));
export const serve = series(json,sprite, parallel(styles, views, scripts, images), devWatch);
